...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"detailShows"]) {
        NSString *test = @"abc";
        HpsDetailsViewController *detailVC = [[HpsDetailsViewController alloc] init];
        detailVC.deviceIdentififerString = test;
